...
echo ""
echo "Example build-args block:"
echo "  build-args: |"
echo "    BASE_IMAGE=\${{ env.REGISTRY }}/\${{ steps.repo.outputs.NAME }}/ros2-base-\${{ matrix.platform }}:latest"
echo "    CUDA_ARCHITECTURES=\${{ matrix.cuda_arch }}"
echo "    REPO_URL=${REPO}"
echo "    BRANCH=${BRANCH}"
echo "    PACKAGE_NAME=${NAME}"
